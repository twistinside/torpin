...
let package = Package(
    name: "TorpinV2EventHandlerLambda",
    platforms: [
        .macOS(.v15)
    ],
    products: [
        .executable(name: "EventHandlerV2Lambda", targets: ["EventHandlerV2Lambda"])
    ],
    dependencies: [
    ...
    targets: [
        ...
        .testTarget(
            name: "EventHandlerV2LambdaTests",
            dependencies: ["EventHandlerV2Lambda"],
            path: "Tests/EventHandlerV2Lambda"
        )
    ]
)
